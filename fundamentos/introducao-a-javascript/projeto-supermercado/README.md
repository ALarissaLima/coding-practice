...
- Data para entrega final do projeto: `31/10/2023 23:59`.
...
- Use o comando: `git clone git@github.com:tryber/sd-038-supermercado-pirilampo.git`

- Entre na pasta do repositório que você acabou de clonar:
  
  - `cd sd-038-supermercado-pirilampo`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-038-supermercado-pirilampo/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-038-supermercado-pirilampo/pulls) e confira se o seu _Pull Request_ está criado
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH38&template=betrybe/sd-0x-supermercado-pirilampo)
