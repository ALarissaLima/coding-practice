...
- Data para entrega final do exercício: `24/11/2023 às 23:59 (Horário de Brasília)`.
...
- Use o comando: `git clone git@github.com:tryber/sd-038-exercise-tests-in-practice`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-038-exercise-tests-in-practice`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-038-exercise-tests-in-practice/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-038-exercise-tests-in-practice/pulls) e confira que o seu _Pull Request_ está criado
