...
- `git clone git@github.com:tryber/sd-038-exercise-exception-handling.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-038-exercise-exception-handling`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-038-exercise-exception-handling/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-038-exercise-exception-handling/pulls) e confira que o seu _Pull Request_ está criado
