...
- Data limite para entrega: `21/11/2023 às 23:59 (Horário de Brasília)`
...
1. Clone o repositório
   ...
   - `git clone git@github.com:tryber/sd-038-project-trybewarts.git`.
   - Entre na pasta do repositório que você acabou de clonar:
     - `cd sd-038-project-trybewarts`
...
4. Crie na raiz do projeto os arquivos que você precisará desenvolver:
   ...
   - Verifique se você está na raiz do projeto
     ...
     - Exemplo: `pwd` -> o retorno vai ser algo como _/Users/joao/code/**sd-038-project-trybewarts**_
...
7. Crie um novo `Pull Request` _(PR)_
   ...
   - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-038-project-trybewarts/pulls)
   ...
   - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-038-project-trybewarts/pulls) e confira que o seu _Pull Request_ está criado
...
Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH38&template=betrybe/sd-0x-project-trybewarts)
